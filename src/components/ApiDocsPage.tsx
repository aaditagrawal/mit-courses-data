        ...
        <div className="min-h-screen bg-background text-foreground font-sans">
            <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16 space-y-10">
                <header className="space-y-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            Query course catalogs and degree plans over a JSON REST API.
                            Copy the docs as Markdown to give your agent full context.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-3">
                        ...
                        <Button variant="ghost" size="sm" className="font-mono text-xs text-muted-foreground" asChild>
                ...
                <section className="space-y-3">
                    <h2 className="text-sm font-semibold uppercase tracking-wider text-muted-foreground">Base URL</h2>
...
{`{
  ...
  "meta": { "total": 42, "count": 20, "query": "..." }
                ...
                <section className="space-y-3">
                    <h2 className="text-sm font-semibold uppercase tracking-wider text-muted-foreground">Query parameters</h2>
                ...
                <section className="space-y-3">
                    <h2 className="text-sm font-semibold uppercase tracking-wider text-muted-foreground">Notes for agents</h2>
                    <ul className="text-sm text-muted-foreground space-y-2 list-disc pl-5">
                        <li>Course codes contain spaces — URL-encode them in path segments (e.g. <code className="font-mono text-xs">MAT%202122</code>).</li>
                        <li>Use <code className="font-mono text-xs">/api/v1/search</code> for broad queries; use resource endpoints when you know the entity type.</li>
                        <li>Paginate with <code className="font-mono text-xs">limit</code> and <code className="font-mono text-xs">offset</code> for large result sets.</li>
