...
import { MoveLeft, BookOpen, GraduationCap, Clock, Building2, Award } from 'lucide-react';
import Link from 'next/link';

export const metadata = {
    title: 'Project Work / Practice School (Honours) | MIT Manipal',
    description: 'Information about 4293 courses - Major Project Work / Practice School for B.Tech Honours students',
};
                            ...
                            <Card className="border-border/50 bg-card/50 shadow-sm">
                                <CardContent className="p-6 space-y-4">
                                    <p className="text-sm leading-relaxed text-muted-foreground">
                                        The Project Work / Practice School (<span className="font-mono text-accent-foreground">XXX 4293</span>) is the capstone project course for students pursuing the <strong className="text-foreground">B.Tech Honours</strong> degree.
                                    </p>
